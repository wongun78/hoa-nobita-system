...
export function GradingV2Page() {
  ...
  return <div className="space-y-5"><PageHeader eyebrow="채점 센터" title="Grading Center" description={isTeacher ? 'Bạn có thể xem toàn bộ bài nộp toàn hệ thống.' : 'Class Admin chỉ xem/chấm trong lớp được gán; hãy chọn lớp để bắt đầu.'} />
